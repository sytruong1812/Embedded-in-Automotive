...
/*
Trong ví dụ, lớp Singleton có một phương thức tĩnh getInstance() để truy xuất đối tượng Singleton. 
Phương thức này kiểm tra xem nếu biến instance chưa được khởi tạo (giá trị ban đầu là nullptr), 
